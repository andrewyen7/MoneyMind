        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          {budgets.length > 0 && (
            <div className="mb-6">
              <BudgetProgressChart 
                budgets={budgets} 
                title="Budget Progress - Spending vs Budgeted Amounts"
              />
            </div>
          )}
            ...
            <div className="bg-white rounded-lg shadow-md">
              <div className="px-6 py-4 border-b border-gray-200">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm text-gray-500">Monthly Budgets</span>
                </div>
              </div>
              {budgetSummary ? (
                <div className="p-6">
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                      ...
                      <div className="flex justify-between items-center border-t pt-2">
                        ...
                        <span className={`text-lg font-semibold ${
                          budgetSummary.totalRemaining >= 0 ? 'text-green-600' : 'text-red-600'
                        }`}>
                      ...
                      <div className="mt-3">
                        <div className="flex justify-between text-xs text-gray-500 mb-1">
                          ...
                          <span>
                            {((budgetSummary.totalSpent / budgetSummary.totalBudgeted) * 100).toFixed(1)}%
                          </span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
                            className={`h-2 rounded-full transition-all duration-300 ${
                              (budgetSummary.totalSpent / budgetSummary.totalBudgeted) >= 1
                                ? 'bg-red-500'
                                : (budgetSummary.totalSpent / budgetSummary.totalBudgeted) >= 0.8
                                ? 'bg-yellow-500'
                                : 'bg-green-500'
                            }`}
                            style={{
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <h4 className="text-sm font-medium text-gray-700 mb-3">Budget Status Summary</h4>
                      <div className="grid grid-cols-3 gap-4 text-center">
                        <div className="bg-green-50 rounded-lg p-3">
                          <div className="text-xl font-bold text-green-600">
                            {budgetSummary.goodCount}
                          </div>
                          <div className="text-xs text-green-700 font-medium">On Track</div>
                        ...
                        <div className="bg-yellow-50 rounded-lg p-3">
                          ...
                          <div className="text-xs text-yellow-700 font-medium">Warning</div>
                        ...
                        <div className="bg-red-50 rounded-lg p-3">
                          ...
                          <div className="text-xs text-red-700 font-medium">Over Budget</div>
                          <div className="text-xs text-gray-500">Exceeded limit</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-6 text-center text-gray-500">
                  ...
                  <p className="text-sm mt-1">Create your first budget to start tracking expenses</p>
                </div>
              )}
              <div className="px-6 py-3 bg-gray-50 border-t border-gray-200">
